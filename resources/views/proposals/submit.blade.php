...
@section('content')
<h2 class="text-2xl text-green-500 mb-5">Vous soumettez une proposition pour la mission "{{ $emploi->title }}"</h2>
<form method="POST" action="{{ route('proposals.submit.store', $emploi->id) }}" class="w-full max-w-md">
  @csrf
