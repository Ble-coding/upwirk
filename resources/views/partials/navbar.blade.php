<div class="flex flex-col md:flex-row justify-between items-center">
  <div class="w-24 h-24">
    <a href="
    {{route('jobs.index') }}
      "><img src="{{ asset('img/upwirk-logo.png') }}"></a>
  </div>
  <ul class="flex flex-col md:flex-row items-center mb-3 md:mb-0">
    ...
    <li class="md:mr-5 py-2 md:py-0"><a href="
    {{ route('jobs.index') }}
    " class="hover:text-green-400">Les missions</a></li>
    <li class="md:mr-5 py-2 md:py-0"><a href="
    {{ route('conversations.index') }}
    " class="hover:text-green-400">Mes conversations</a></li>
